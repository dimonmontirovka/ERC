def main():
	print("Created By ERC")
	print("Ver: 1.0")
	print("==================================================================")
	print("Turn your Device into Test Machine")
def change():
	print("==================================================================")
	print('1 - BrutForce')
	print('2 - WebTest')
	print('3 - SmSBomber')
	change=int(input('Function: '))
	if change==1:
		brutforce()
	if change==2:
		test()
...
def test():
	print('==================================================================')
	import requests
	print('Example URL: https://yandex.ru')
	URL=input('Your URL: ')
	for x in range(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999):
...
def brutforce():
	...
	print(".#######..##....##..#######......##...")
	import random
	print('aircrack-ng importing')
	import os
	print('os module importing')
	import time
	print("==================================================================")
	print('1-En')
	print('2-RU')
	print('3-Num')
	language=int(input("DICTIONARY: "))
	if language==1:
		tr=9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
		mute=input("Target: ")
		for x in range(tr):
			chars=("qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM")
			n=len(mute)
			password=''
			for i in range(n): #в скообках количесвто знаков в пароле // цикл генерации пароля
			...
			if mute == password:
				...
				change()
	if language==2:
		tr = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
		mute = input("Target: ")
		for x in range(tr):
	...
	if language==3:
		password=[]
		password0=int(input("Target: "))
		password.append(password0)
		brut=0
		while brut!=password:
			brut+=1
			print(brut)
...
def bomber():
	...
	import random
	print('==================================================================')
	print('created by ERC with KingSoul')
